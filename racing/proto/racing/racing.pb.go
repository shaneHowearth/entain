...
const file_racing_racing_proto_rawDesc = "" +
	"\n" +
	"\x13racing/racing.proto\x12\x06racing\x1a\x1fgoogle/protobuf/timestamp.proto\")\n" +
	...
	"\x13SORT_DIRECTION_DESC\x10\x022\x8a\x01\n" +
	"\x06Racing\x12<\n" +
	"\aGetRace\x12\x16.racing.GetRaceRequest\x1a\x17.racing.GetRaceResponse\"\x00\x12B\n" +
